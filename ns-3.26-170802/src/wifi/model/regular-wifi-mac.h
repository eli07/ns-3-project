...
// NETSYS ----------------------------------------------------------------------
	virtual void SetIfIndex(uint16_t ifIndex);
//------------------------------------------------------------------------------
  ...
  typedef Callback<void, Ptr<Packet>, Mac48Address, Mac48Address> ForwardUpCallback;
	...
	// NETSYS ------------------------------------------------------------------
	typedef Callback<void> GotAckCallback;
	typedef Callback<void> OverheardAckCallback;
	typedef Callback<void> MissedAckCallback;
	//--------------------------------------------------------------------------
  ...
  virtual void SetForwardUpCallback (ForwardUpCallback upCallback);
	...
	// NETSYS ------------------------------------------------------------------
	virtual void SetGotAckCallback(GotAckCallback gotAckCallback);
	virtual void SetMissedAckCallback(MissedAckCallback missedAckCallback);
	virtual void SetOverheardAckCallback(OverheardAckCallback overheardAckCallback);
	//--------------------------------------------------------------------------
...
protected:
  ...
  Callback<void> m_linkDown;     //!< Callback when a link is down
	...
	// NETSYS ------------------------------------------------------------------
	GotAckCallback m_gotAck;
	MissedAckCallback m_missedAck;
	OverheardAckCallback m_overheardAck;
	//--------------------------------------------------------------------------
  ...
  virtual void TxOk (const WifiMacHeader &hdr);
	...
	virtual void OverheardAck();
	virtual void SetToken(bool cmd);
	virtual void SetDebug(bool cmd);
	virtual uint32_t GetBEQueueSize();
	//--------------------------------------------------------------------------
