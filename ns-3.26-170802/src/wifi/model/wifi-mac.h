...
// NETSYS ----------------------------------------------------------------------
  virtual void SetIfIndex(uint16_t ifIndex) = 0;
//------------------------------------------------------------------------------
...
// NETSYS ----------------------------------------------------------------------
	virtual void SetGotAckCallback(Callback<void> gotAck) = 0;
	virtual void SetMissedAckCallback(Callback<void> gotAck) = 0;
	virtual void SetOverheardAckCallback(Callback<void> overheardAck) = 0;
	virtual void SetToken(bool cmd) = 0;
	virtual void SetDebug(bool cmd) = 0;
	virtual uint32_t GetBEQueueSize() = 0;
//------------------------------------------------------------------------------
