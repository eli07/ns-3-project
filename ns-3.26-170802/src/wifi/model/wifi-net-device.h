...
public:
	...
	// NETSYS ------------------------------------------------------------------
	typedef Callback<void, uint32_t> WifiNetDeviceGotAckCallback;
	typedef Callback<void, uint32_t> WifiNetDeviceMissedAckCallback;
	typedef Callback<void, uint32_t> WifiNetDeviceOverheardAckCallback;
	//--------------------------------------------------------------------------
  ...
  virtual bool SupportsSendFrom (void) const;
	...
	// NETSYS ------------------------------------------------------------------
	WifiNetDeviceGotAckCallback m_gotAckCallback;
	WifiNetDeviceMissedAckCallback m_missedAckCallback;
	WifiNetDeviceOverheardAckCallback m_overheardAckCallback;

	void SetGotAckCallback(WifiNetDeviceGotAckCallback callback);
	void SetMissedAckCallback(WifiNetDeviceMissedAckCallback callback);
	void SetOverheardAckCallback(WifiNetDeviceOverheardAckCallback callback);

	void SetToken(bool cmd);
	void SetDebug(bool cmd);

	uint32_t GetBEQueueSize();
	//--------------------------------------------------------------------------
