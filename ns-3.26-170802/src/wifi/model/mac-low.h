...
public:
  ...
  typedef Callback<void, Ptr<Packet>, const WifiMacHeader*> MacLowRxCallback;
	...
	// NETSYS ------------------------------------------------------------------
	typedef Callback<void> MacLowOverheardAckCallback;
	//--------------------------------------------------------------------------
...
// NETSYS ----------------------------------------------------------------------
	void SetIfIndex(uint16_t ifIndex);
	void SetDebug(bool cmd);
	bool GetDebug();
    uint16_t GetIfIndex(void) const;
//------------------------------------------------------------------------------
  ...
  void SetRxCallback (Callback<void,Ptr<Packet>,const WifiMacHeader *> callback);
	...
	// NETSYS ------------------------------------------------------------------
	void SetOverheardAckCallback(Callback<void>);
	//--------------------------------------------------------------------------
...
private:
  ...
  MacLowRxCallback m_rxCallback; //!< Callback to pass packet up
	...
	// NETSYS ------------------------------------------------------------------
	MacLowOverheardAckCallback m_overheardAckCallback;
	//--------------------------------------------------------------------------
