...
public:
  ...
  typedef Callback <void, const WifiMacHeader&> TxFailed;
	...
	// NETSYS ------------------------------------------------------------------
	typedef Callback <void> EdcaTxopNGotAck;
	typedef Callback <void> EdcaTxopNMissedAck;
	//--------------------------------------------------------------------------
  ...
  void SetTxOkCallback (TxOk callback);
	...
	// NETSYS ------------------------------------------------------------------
	void SetGotAckCallback(EdcaTxopNGotAck callback);
	void SetMissedAckCallback(EdcaTxopNMissedAck callback);
...
private:
  ...
  TxFailed m_txFailedCallback;
	...
	EdcaTxopNGotAck m_gotAckCallback;
	EdcaTxopNMissedAck m_missedAckCallback;
